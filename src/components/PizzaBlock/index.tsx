    ...
    return (
        <div className="pizza-block">
            ...
            <div className="pizza-block__selector">
                <ul>
                    {/* Что касается сохранения стейта, мы можем использовать тут альтернативный вариант сразу подставить функции сохранения стейта в стрелочную функцию. Когда у нас подобная ситуация, когда у нам нужно делать одну лишь функцию сохранения стейта, вполне подходящий вариант и более коротки, в отличие от того, что я сделал в [Categories.tsx]. */}
                    {doughTypeNames.map((typeName, index) => (
                        <li
                            onClick={() => setDoughType(index)}
                            key={typeName}
                            className={pizzaDoughType === index ? 'active' : ''}
                        >
                            {doughTypeNames[index]}
                        </li>
                    ))}
                </ul>
                <ul>
