...
export default function Categories() {
	...
	// 6.0 Сделаем рендеринг категорий из массива при помощи метода map.
	...
	// 6.1 Далее мы создадим анонимную стрелочную функцию, которая будет вызывать функцию onClickCategory и передадим в неё индекс каждого из элементов.
