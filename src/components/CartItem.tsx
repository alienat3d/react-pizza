...
import {addItem, Items, removeItem, removeItems} from "../redux/slices/cartSlice"

// 22.8.0 Здесь мы добавим типизацию объекта из слайса корзины для аргументов "Items". ↓
const CartItem = ({id, img, title, dough, size, price, amount}: Items) => {
...
/* 22.8.1 Эти типы мы уже можем убрать, т.к. теперь у нас используется Interface из типизации TypeScript [cartSlice.ts]
CartItem.propTypes = {
