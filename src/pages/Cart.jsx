          ...
          <div className="content__items">
            <div className="cart__item">
              <div className="cart__item-img">
                <img
                  ...
                  src="/src/assets/img/pizza/four-seasons.webp"
                  alt="Pizza"
                />
              </div>
            ...
            <div className="cart__item">
              <div className="cart__item-img">
                <img
                  className="pizza-block__image"
                  src="/src/assets/img/pizza/chicken-ranch.webp"
                  alt="Pizza"
                />
              </div>
              <div className="cart__item-info">
            ...
            <div className="cart__item">
              <div className="cart__item-img">
                <img
                  className="pizza-block__image"
                  src="/src/assets/img/pizza/julien.webp"
                  alt="Пицца Жульен"
                />
              </div>
              <div className="cart__item-info">
            ...
            <div className="cart__item">
              <div className="cart__item-img">
                <img
                  className="pizza-block__image"
                  src="/src/assets/img/pizza/chorizo-fresh.webp"
                  alt="Пицца Чорицо"
                />
              </div>
              <div className="cart__item-info">
